...
## Purpose  
This guide ensures that email communications are **clear, engaging, and easy to read**, while maintaining a **friendly, conversational tone**. It follows **Smart Brevity principles** to keep messages **concise, actionable, and accessible** for diverse audiences.  
...
### 1.3 Direct & Actionable Language  
✅ Clearly state what the reader **needs to know and do**  
...
### 2.2 Email Structure  
Use the **Smart Brevity format**:  

1. **Start with the key message** – What’s happening? Why does it matter?  
...
Your password is about to expire on **[Date]**. Here’s what you need to do:

✔ Create a new password with **15+ characters**  
✔ Use a **passphrase** (e.g., **SunsetOverTheMountains**)  
✔ **Don’t reuse old passwords**  

Need help? Click below to reset your password.  
...
No more uppercase, number, or special character requirements
...
✅ Are action steps clear and easy to follow?
✅ Is the email skimmable with good formatting?
